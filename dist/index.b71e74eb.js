...
(function() {
    ...
    _home.initHomepage(root);
})();

},{"./components/text":"6Xncd","./components/todo-item":"03CfC","./pages/home":"l5Ogl","./state":"1Yeju"}],"6Xncd":[function(require,module,exports) {
...
},{}],"03CfC":[function(require,module,exports) {
...
function initHomepage(containerEl) {
    ...
    const tasks1 = _state.state.getEnabledTasks();
    div.innerHTML = `
    ...
    function createTasks(tasks) {
        ...
        for (const i of tasks){
            ...
            if (i.completed) todoItemEl.setAttribute("checked", "true");
            todoItemEl.addEventListener("change", (e)=>{
                _state.state.changeItemsState(e.detail.id, e.detail.value);
            });
...
},{}]},["7mgxS","h7u1C"], "h7u1C", "parcelRequire716c")
